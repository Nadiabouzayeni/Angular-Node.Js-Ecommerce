...
export class PanierComponent implements OnInit {
  ...
  calculateTotal() {
    let total = 0;
    for (let order of this.productAdded) {
      total += order.product.prix * order.quantity;
    }
    return total;
  }
//stripeAPIKey
  ...
  stripeAPIKey: any ='pk_test_51OI5cQFJVgn6guIM8ETNoutWzBtqvvPp615Yv5KwEFkLAaQiEPhM3RGIzjDWGn8dL3gSQRmDU21zs1t0tqP9Iyks00DZct9dJH';
